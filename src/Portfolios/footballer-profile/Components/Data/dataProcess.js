...
export const pentagonScaleProcess = (val, i) => {
  return [Math.PI * (i * (2 / 5)), val];
};
// ?dATA cOLUMNS No,Name,Squad,PassCMP%,AttPen,NpXgXa,SCA,Tkl,Inter,Block,PPass,Pcarry,Press
